...
2. Create new Proxy Host:
   - **Domain Names**: `api.mom-recipes.tachyonfuture.com`
   - **Scheme**: `http`
...
1. Create new Proxy Host:
   - **Domain Names**: `mom-recipes.tachyonfuture.com`
   - **Scheme**: `http`
...
# Test backend API
curl https://api.mom-recipes.tachyonfuture.com/health

# Test frontend
curl https://mom-recipes.tachyonfuture.com
