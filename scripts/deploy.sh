...
echo "      - Frontend: mom-recipes.tachyonfuture.com → moms-recipes-frontend:80"
echo "      - Backend: api.mom-recipes.tachyonfuture.com → moms-recipes-backend:3001"
echo ""
echo "   2. Test the deployment:"
echo "      - Backend: curl http://localhost:3001/health"
echo "      - After NPM: https://mom-recipes.tachyonfuture.com"
echo ""
echo "   3. Monitor logs:"
