...
echo "      - Frontend: recipes.tachyonfuture.com → moms-recipes-frontend:80"
echo "      - Backend: api.recipes.tachyonfuture.com → moms-recipes-backend:3001"
echo ""
echo "   2. Test the deployment:"
echo "      - Backend: curl http://localhost:3001/health"
echo "      - After NPM: https://recipes.tachyonfuture.com"
echo ""
echo "   3. Monitor logs:"
